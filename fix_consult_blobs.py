...
import re
pattern = re.compile(r'\{\/\* Aesthetic background blobs for Consult glass cards \*\/\}.*?<div[^>]+>.*?<div[^>]+>.*?<div[^>]+>.*?<div[^>]+>', re.DOTALL)
...
print("Reverted ConsultPage blobs to exactly the 3 small diet patches")
