...
# Add Happy High Energy to the array
content = re.sub(r'\{\[\s*\{\s*title:\s*\'Deep Sleep\'.*?\{\s*title:\s*\'Deep Focus\'.*?\}\s*\]\.map', r"""{[
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated CaseDashboard.tsx for Happy High Energy array")
