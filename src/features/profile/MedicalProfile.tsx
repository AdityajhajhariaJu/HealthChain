  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ position: 'absolute', top: '-20px', right: '-20px', width: '200px', height: '200px', background: 'var(--teal)', filter: 'blur(80px)', transform: 'translateZ(0)', willChange: 'transform', opacity: 0.1, borderRadius: '50%' }} />
        <div style={{ position: 'absolute', bottom: '-40px', left: '10%', width: '200px', height: '200px', background: '#3b82f6', filter: 'blur(100px)', transform: 'translateZ(0)', willChange: 'transform', opacity: 0.05, borderRadius: '50%' }} />
