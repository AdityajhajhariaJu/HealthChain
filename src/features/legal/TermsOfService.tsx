      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', paddingBottom: '60px' }}>
        ...
        >
          ...
          <p style={{ marginBottom: '16px', color: 'var(--text-secondary)', padding: '16px', backgroundColor: 'rgba(239, 68, 68, 0.1)', borderLeft: '4px solid #ef4444', borderRadius: '4px' }}>
            <strong>HealthChain is an AI-powered informational tool, not a doctor.</strong> The information, diagnoses, and treatment plans generated by this application are for educational and informational purposes only. They are not a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition. <strong>In the event of a medical emergency, call emergency services immediately.</strong>
          </p>
