                ...
                <>
                  ...
                  <div style={{ display: 'flex', gap: '12px', flexDirection: isMobile ? 'column' : 'row' }}>
                    ...
                    <button
                      ...
                      onMouseLeave={(e) => (e.currentTarget.style.background = 'var(--surface)')}
                    >
                      <svg width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.19 2.31-.88 3.5-.8 1.14.03 2.14.47 2.8 1.14-2.58 1.4-2.11 4.79.52 5.82-.67 1.81-1.48 3.57-2.9 5.01h1zm-4.71-13.6c-.19-2.25 1.77-4.14 3.9-4.22.25 2.35-1.99 4.39-3.9 4.22z"/></svg>
                      Apple
                    </button>
                  </div>
                </>
