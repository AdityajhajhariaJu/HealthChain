...
const MeditationHeroCard = ({ item, onClick, getFallbackImage }: any) => (
  <div onClick={onClick} style={{
    ...
    <div style={{ position: 'absolute', bottom: '20px', left: '20px', right: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
      ...
      <button aria-label="Play video" style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(255,255,255,0.8)', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(4px)', minWidth: '40px', minHeight: '40px', flexShrink: 0, cursor: 'pointer' }}>
    ...
    <div style={{
      ...
      <FatigueModeToggle />
        ...
        <div style={{ paddingBottom: "32px", borderTop: "1px solid rgba(0,0,0,0.03)", paddingTop: "32px" }}>
          ...
          <div style={{ position: 'absolute', bottom: '10%', left: '50%', width: '90px', height: '90px', background: '#A7F3D0', borderRadius: '50%', filter: 'blur(30px)', transform: 'translateX(-50%) translateZ(0)', willChange: 'transform', zIndex: 0 }} />
              ...
              <div key={i} onClick={() => triggerHapticLight()} style={{
                ...
                <div style={{ position: 'relative', height: '150px', width: '100%' }}>
                  ...
                  <div style={{ position: 'absolute', bottom: '12px', right: '12px', display: 'flex', gap: '8px' }}>
                    <button aria-label="Like" style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'rgba(255,255,255,0.85)', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748B', backdropFilter: 'blur(4px)', padding: 0, minWidth: '32px', minHeight: '32px', flexShrink: 0, cursor: 'pointer' }}>
                      <Heart size={16} strokeWidth={1.5} />
                    </button>
                    <button aria-label="Share" style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'rgba(255,255,255,0.85)', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748B', backdropFilter: 'blur(4px)', padding: 0, minWidth: '32px', minHeight: '32px', flexShrink: 0, cursor: 'pointer' }}>
                      <Share2 size={16} strokeWidth={1.5} />
                    </button>
                    <button aria-label="Bookmark" style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'rgba(255,255,255,0.85)', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748B', backdropFilter: 'blur(4px)', padding: 0, minWidth: '32px', minHeight: '32px', flexShrink: 0, cursor: 'pointer' }}>
