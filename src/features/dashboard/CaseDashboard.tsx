...
export default function CaseDashboard() {
  ...
  useEffect(() => {
    ...
    if (profile?.medications?.length) {
      profile.medications.forEach((m: any, i: number) =>
        tasks.push({ id: 'med_' + i, title: m.name || m, subtitle: 'Scheduled Medication' })
      );
    }
    if (tasks.length === 0) {
      tasks.push({
  ...
  const handleStartContent = (content: FitnessContent) => {
    ...
    if (
      ...
      content.type === 'breathwork' ||
      content.type === 'soundscape'
    ) {
  ...
  const ProgramCard = ({ title, subtitle, gradient, icon, onClick }: any) => (
    ...
    >
      ...
      <div style={{ alignSelf: 'flex-end', color: 'rgba(255,255,255,0.9)' }}>{icon}</div>
    </div>
  );
    ...
    >
      ...
      >
        <img
          loading="lazy"
          decoding="async"
          src={item.cover_image_url || getFallbackImage(item.type, item.id)}
          alt={item.title}
        ...
        <div>
          ...
          >
            <div style={{ display: 'flex', gap: '2px', alignItems: 'center' }}>
              <div
                style={{ width: '2px', height: '8px', background: 'white', borderRadius: '1px' }}
              />
              <div
                style={{ width: '2px', height: '12px', background: 'white', borderRadius: '1px' }}
              />
              <div
                style={{ width: '2px', height: '8px', background: 'white', borderRadius: '1px' }}
              />
  ...
  const MindfulnessGridItem = ({ item, onClick, getFallbackImage }: any) => (
    ...
    >
      ...
      <div>
        ...
        <p style={{ margin: '2px 0 0', fontSize: '13px', color: '#BAE6FD' }}>
          {item.duration_minutes} min
        </p>
      </div>
    </div>
  ...
  const allWorkouts = Object.values(contentMap)
    .flat()
    .filter((c) => ['workout', 'hiit', 'strength', 'yoga'].includes(c.type));
  const beginnerWorkouts = allWorkouts.filter((w) => w.difficulty === 'Beginner').slice(0, 4);
  const intermediateWorkouts = allWorkouts
    .filter((w) => w.difficulty === 'Intermediate')
    .slice(0, 4);

  const allMeditations = Object.values(contentMap)
    .flat()
    .filter((c) => ['meditation', 'breathwork', 'soundscape'].includes(c.type));
    ...
    >
      ...
      <div style={{ padding: '0 24px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
          ...
          >
            ...
            >
              <div
                style={{
                  ...
                  height: 80,
                  background:
                    'linear-gradient(to bottom, rgba(170,140,44,0.3) 0%, rgba(170,140,44,0.9) 100%)',
                }}
              />
              <div
                style={{
                  ...
                  boxShadow: '0 8px 16px rgba(170,140,44,0.2)',
                  display: 'grid',
                  placeItems: 'center',
                }}
              >
            ...
            <div
              style={{ position: 'relative', zIndex: 1, marginTop: '80px', textAlign: 'center' }}
            >
              <h3
                style={{
                  fontSize: '26px',
            ...
            >
              <div
                style={{
                  ...
                  boxShadow: '0 4px 12px rgba(15,23,42,0.3), inset 0 2px 4px rgba(255,255,255,0.2)',
          ...
          {dailyTasks.map((task, idx) => (
            ...
            >
              ...
              >
                <div
                  style={{
                    ...
                    boxShadow:
                      task.id === 'task_default_done'
                        ? '0 4px 12px rgba(16,185,129,0.3), inset 0 2px 4px rgba(255,255,255,0.3)'
                        : '0 4px 12px rgba(0,0,0,0.05), inset 0 2px 4px rgba(255,255,255,1)',
              ...
              <div>
                ...
                <p style={{ fontSize: '12px', color: '#BAE6FD', margin: 0, fontWeight: 500 }}>
                  {task.subtitle}
                </p>
              </div>
            </div>
          ...
          <section>
            <div style={{ padding: '0 16px', marginBottom: '16px' }}>
              ...
              <p style={{ fontSize: '14px', color: '#64748B', margin: 0 }}>
                Curated experiences to shift your state
              </p>
            </div>
            <div
              style={{
              ...
              {[
                {
                  ...
                  icon: <Waves size={24} />,
                  color: '#3b82f6',
                  img: 'https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=400&q=80',
                },
                {
                ...
                },
                {
                  ...
                  icon: <Wind size={24} />,
                  color: '#10b981',
                  img: 'https://images.unsplash.com/photo-1447452001602-7090c7ab2db3?w=400&q=80',
                },
              ].map((type, i) => (
                <button
                  key={i}
                  ...
                  onClick={() => {
                    ...
                    setActiveMeditation({
                      ...
                      title: type.name,
                      subtitle:
                        type.name === 'Rain Sounds'
                          ? 'Continuous gentle downpour'
                          : type.name === 'Focus Frequencies'
                            ? '432Hz ambient hum'
                            : 'Immersive woodland ecosystem',
                      description:
                        type.name === 'Rain Sounds'
                          ? 'A continuous, looping recording of gentle rain falling on leaves. Perfect for masking background noise and creating a cozy, isolated environment for reading or sleeping.'
                          : type.name === 'Focus Frequencies'
                            ? 'A continuous 432Hz frequency hum mixed with subtle brown noise. Scientifically engineered to block out distractions and narrow your attentional focus.'
      ...
      <section style={{ padding: '32px 0 100px' }}>
        ...
        >
          ...
          <span style={{ fontSize: '13px', color: '#64748B', fontWeight: 500, cursor: 'pointer' }}>
            View all
          </span>
        </div>
              ...
              <div style={{ position: 'relative', height: '150px', width: '100%' }}>
                ...
                {art.isPopular && (
                  ...
                  >
                    ...
                    <span style={{ fontSize: '12px', fontWeight: 600, color: '#2E2B5F' }}>
                      Popular
                    </span>
                  </div>
                )}
      ...
      <ClinicalFrictionModal
        isOpen={showFrictionModal}
        onComplete={() => setShowFrictionModal(false)}
      />
      <ContentDetailPage
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {activeCollection?.items.length === 0 ? (
              <p style={{ color: '#64748B', textAlign: 'center', marginTop: '40px' }}>
                No content available in this collection yet.
              </p>
            ) : (
