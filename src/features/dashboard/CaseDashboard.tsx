...
const MindfulnessGridItem = ({ item, onClick, getFallbackImage }: any) => (
  ...
  if (error) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#EDE8E3', padding: '24px' }}>
  ...
  return (
    <div style={{
      width: '100%',
      backgroundColor: '#EDE8E3', // Premium creme background for Apple style
      minHeight: '100vh',
      display: 'flex',
