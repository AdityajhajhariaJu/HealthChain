          ...
          >
            <div style={{ position: 'relative', height: '40vh', width: '100%' }}>
              ...
              <button 
                ...
                style={{ position: 'absolute', top: 'max(env(safe-area-inset-top, 20px), 20px)', left: '16px', width: '40px', height: '40px', borderRadius: '50%', backgroundColor: 'rgba(255,255,255,0.4)', backdropFilter: 'blur(12px)', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', zIndex: 10 }}
              >
