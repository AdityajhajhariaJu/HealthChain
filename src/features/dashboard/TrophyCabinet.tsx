        ...
        {selectedBadge && (
          ...
          >
            ...
            >
              ...
              <div style={{ position: 'absolute', top: '50%', left: '50%', width: '200px', height: '200px', borderRadius: '50%', background: selectedBadge.color, filter: 'blur(80px)', transform: 'translate(-50%, -50%) translateZ(0)', willChange: 'transform', opacity: 0.3, zIndex: 0 }} />
