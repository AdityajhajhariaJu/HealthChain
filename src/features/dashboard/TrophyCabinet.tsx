...
const BADGE_DICTIONARY = [
  ...
  },
  {
    slug: '10_workouts',
    title: 'Dedicated',
    desc: 'Completed 10 total sessions.',
    icon: '🥇',
    color: '#10B981',
    rarity: 'Rare',
  },
  {
    slug: 'mindful_master',
    title: 'Zen Master',
    desc: 'Logged 5 mindfulness minutes.',
    icon: '🧘',
    color: '#8B5CF6',
    rarity: 'Rare',
  },
  {
    slug: 'early_bird',
    title: 'Early Bird',
    desc: 'Completed a workout before 6 AM.',
    icon: '🌅',
    color: '#3B82F6',
    rarity: 'Epic',
  },
  {
    slug: 'night_owl',
    title: 'Night Owl',
    desc: 'Completed a workout after 9 PM.',
    icon: '🦉',
    color: '#6366F1',
    rarity: 'Epic',
  },
  {
    slug: 'iron_lungs',
    title: 'Iron Lungs',
    desc: 'Finished the advanced breathing track.',
    icon: '💨',
    color: '#06B6D4',
    rarity: 'Legendary',
  },
  {
    slug: 'marathoner',
    title: 'Marathoner',
    desc: 'Burned over 10,000 active calories.',
    icon: '👟',
    color: '#F43F5E',
    rarity: 'Legendary',
  },
    ...
    >
      ...
      <div style={{ padding: isMobile ? '32px 24px 16px' : '48px 40px 24px' }}>
        ...
        <p style={{ margin: '8px 0 0', color: '#64748B', fontSize: '16px' }}>
          Your lifetime achievements and milestones.
        </p>
      </div>
                ...
                <button
                  onClick={() => {
                    ...
                    if (navigator.share) {
                      ...
                      alert(
                        'Your browser does not support native sharing. Screenshot this card instead!'
                      );
                    }
                  }}
                  style={{
