...
vi.mock('../../services/CaseEngine', () => ({ getCase: (id: string) => mocks.cases.find(c => c.id === id), getActiveCase: () => null, createCaseDraft: mocks.create, saveReviewSnapshot: mocks.save }));
...
vi.mock('../../services/HealthMemory', () => ({ recordHealthMemory: vi.fn() }));
