      ...
      <div className="print-hide" style={{ display: 'flex', flexWrap: 'wrap', gap: 20, alignItems: 'flex-start' }}>
        <section className="card" style={{ padding: '32px', flex: '1 1 500px', minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 24, flexWrap: 'wrap' }}>
              ...
              <button className="btn btn-outline" onClick={() => { clearCasePrepDraft(); setConcern(''); setTimeline(''); setRecords(''); setAppointment(''); setGoal(''); setCareSoFar(''); setCaseItem(null);  setSmartQuestions([]); }}  title="Clear saved draft" style={{ padding: '0 14px' }}><Trash2 size={18} /></button>
          </div>
        </section>
