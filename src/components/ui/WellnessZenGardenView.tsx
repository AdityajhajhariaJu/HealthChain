    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ position: 'relative', background: 'radial-gradient(ellipse at top, #FFFFFF 0%, #FFFAFA 45%, #FFF7F8 100%)', borderRadius: '28px', padding: '24px 20px', border: '1.5px solid #F1E5E7', boxShadow: '0 16px 40px rgba(0, 0, 0, 0.04)', display: 'flex', flexDirection: 'column', alignItems: 'center', overflow: 'hidden', minHeight: '260px' }}>
        ...
        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <motion.div animate={{ y: [0, -6, 0] }} transition={{ repeat: Infinity, duration: 3, ease: 'easeInOut' }} style={{ position: 'relative', width: '90px', height: '90px', borderRadius: '50%', background: 'linear-gradient(135deg, #FFFFFF 0%, #FFF7F8 100%)', border: '3px solid #F9D2D7', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 24px rgba(205, 49, 83, 0.18)', zIndex: 2 }}>
            <span style={{ fontSize: '42px', display: 'block' }}>🧘</span>
            <div style={{ position: 'absolute', top: '-4px', background: '#CD3153', color: '#FFFFFF', fontSize: '9px', fontWeight: 800, padding: '2px 8px', borderRadius: '999px', letterSpacing: '0.4px', textTransform: 'uppercase', boxShadow: '0 2px 6px rgba(205, 49, 83, 0.25)' }}>ZEN AVA</div>
          </motion.div>

          <div style={{ marginTop: '-18px', width: '210px', height: '56px', borderRadius: '50%', background: 'linear-gradient(180deg, #86EFAC 0%, #4ADE80 50%, #22C55E 100%)', border: '2.5px solid #BBF7D0', boxShadow: '0 12px 28px rgba(34, 197, 94, 0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', zIndex: 1 }}>
        ...
        {showGuide && (
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} style={{ marginTop: '16px', background: '#FFFAFA', borderRadius: '16px', padding: '8px 18px', border: '1px solid #F1E5E7', textAlign: 'center', boxShadow: '0 4px 14px rgba(0, 0, 0, 0.04)' }}>
            <div style={{ fontSize: '11px', fontWeight: 800, color: '#CD3153', textTransform: 'uppercase' }}>How this garden works</div>
      ...
      <div style={{ background: '#FFFFFF', borderRadius: '22px', padding: '18px 20px', border: '1.5px solid #F1E5E7', boxShadow: '0 8px 24px rgba(0, 0, 0, 0.03)', display: 'flex', flexDirection: 'column', gap: '14px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <span style={{ fontSize: '12px', fontWeight: 800, color: '#CD3153', background: '#FEF2F3', padding: '4px 12px', borderRadius: '999px', border: '1px solid #F9D2D7' }}>Level {garden.level} • {garden.gardenStage.replace('_', ' ').toUpperCase()}</span>
        </div>
        <div style={{ width: '100%', height: '8px', background: '#F1E5E7', borderRadius: '999px', overflow: 'hidden' }}>
...
const metricCardStyle = { background: '#FFFAFA', padding: '10px 8px', borderRadius: '12px', textAlign: 'center', border: '1px solid #F1E5E7' } as const;
