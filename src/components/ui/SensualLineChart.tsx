...
export const SensualLineChart: React.FC<SensualLineChartProps> = React.memo<SensualLineChartProps>(({ data: propData }) => {
  ...
  const { points, pathData, areaData } = useMemo(() => {
    ...
    return { points: calculatedPoints, pathData: calculatedPathData, areaData: calculatedAreaData };
  }, [data, height, width, padding, max]);
