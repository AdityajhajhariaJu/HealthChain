            ...
            {!expanded && (
              ...
              >
                <span style={{ color: '#F8FAFC', fontSize: '14px', fontWeight: 600, letterSpacing: '-0.2px' }}>
                  ...
                  <button onClick={(e) => { e.stopPropagation(); dismissIsland(); setExpanded(false); }} style={{ background: 'transparent', border: 'none', color: '#94A3B8', padding: '4px', marginLeft: '2px', display: 'flex', cursor: 'pointer' }} aria-label="Dismiss action"><X size={14} /></button>
              </motion.div>
            )}
          </AnimatePresence>
