      ...
      >
            ...
            {!expanded && (
              ...
              >
                <span style={{ color: '#F8FAFC', fontSize: '14px', fontWeight: 600, letterSpacing: '-0.2px' }}>
                  ...
                  <button aria-label="Dismiss" onClick={(e) => { e.stopPropagation(); dismissIsland(); setExpanded(false); }} style={{ background: 'transparent', border: 'none', color: '#94A3B8', padding: '4px', marginLeft: '2px', display: 'flex', cursor: 'pointer' }}><X size={14} /></button>
              </motion.div>
            )}
          </AnimatePresence>
        ...
        <AnimatePresence>
          {expanded && (
            ...
            >
              <button aria-label="Dismiss" onClick={(e) => { e.stopPropagation(); dismissIsland(); setExpanded(false); }} style={{ width: '44px', padding: '12px', borderRadius: '16px', background: 'rgba(255,255,255,0.1)', color: '#FFF', display: 'flex', justifyContent: 'center', alignItems: 'center', border: 'none', cursor: 'pointer' }}><X size={16} /></button>
                <button 
