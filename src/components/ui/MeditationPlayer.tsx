...
import { MEDITATION_TRACKS, DEEP_SLEEP_TRACKS, DEEP_FOCUS_TRACKS, HAPPY_HIGH_ENERGY_TRACKS, FOCUS_FREQUENCIES_TRACKS, FOREST_AMBIENCE_TRACKS } from '../../data/MeditationTracks';
...
export const MeditationPlayer: React.FC<MeditationPlayerProps> = ({ content, onClose }) => {
  ...
  const isPlaylistMode = content?.id === 'm1' || content?.id === 'mood-0' || content?.id === 'mood-1' || content?.id === 'mood-2' || content?.id === 'soundscape-1' || content?.id === 'soundscape-2';
