...
export function VitalityNav() {
  ...
  return (
    <nav 
      aria-label="Vitality Navigation"
      style={{
        display: 'flex',
        flexWrap: 'nowrap',
        gap: '8px',
    ...
    >
      <style>{`
        .vitality-nav::-webkit-scrollbar { display: none; }
      `}</style>
      <div className="vitality-nav" style={{ display: 'flex', flexWrap: 'nowrap', gap: '8px', minWidth: 'min-content', padding: '0 24px' }}>
        {tabs.map(tab => {
