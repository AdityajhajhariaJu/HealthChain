...
pattern = re.compile(r'\{\/\* Aesthetic background blobs for J\.A\.R\.V\.I\.S sheer glass card \*\/\}.*?<div[^>]+>.*?<div[^>]+>.*?<div[^>]+>', re.DOTALL)
...
print("Reverted JARVIS blobs to exactly the 3 small diet patches")
